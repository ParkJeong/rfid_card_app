...
public class NFCPushActivity extends Activity {
    ...
    public static String sourceMsg = "This is check!";
    ...
    public void onCreate(Bundle savedState) {
        ...
        if (mAdapter != null) {
            ...
            mText.setText("NFC를 읽기/쓰기모드로 활성화하세요.");
        }
    ...
    public static NdefRecord createTextRecord(String text, Locale locale, boolean encodeInUtf8) {
        ...
        return new NdefRecord(NdefRecord.TNF_WELL_KNOWN, NdefRecord.RTD_TEXT, new byte[0], data);//TWK
    }
